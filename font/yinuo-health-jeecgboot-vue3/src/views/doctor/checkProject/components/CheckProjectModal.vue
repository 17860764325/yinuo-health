<template>
  ...
  <!-- 子表单区域 -->
    <a-tabs v-model:activeKey="activeKey" animated @change="handleChangeTabs">
      <a-tab-pane tab="详细项目" key="checkProjectDetail" :forceRender="true">
        <JVxeTable
          keep-source
          resizable
    ...
    const [registerModal, {setModalProps, closeModal}] = useModalInner(async (data) => {
        ...
        if (unref(isUpdate)) {
          ...
          console.log(data.record)
             requestSubTableData(queryCheckProjectDetail, {id:data?.record?.labItemId}, checkProjectDetailTable)
        }
        // 隐藏底部时禁用整个表单
